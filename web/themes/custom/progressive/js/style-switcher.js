jQuery(function ($) {
  ...
  $('.styles-switcher-colors a').click(function () {
    $('.style-switcher').prev("link[href^='/d8/themes/custom/progressive/css/customizer/']")
      .attr("href", "/d8/themes/custom/progressive/css/customizer/" + $(this)
      .attr('data-color') + "-pages-customizer.css");
    return false;
  });
  ...
  $(".layout-rtl").click(function (e) {
    ...
    $(this).addClass('active');
    $("html").attr("dir", 'rtl');
    $('body').append('<link rel="stylesheet" href="/d8/themes/custom/progressive/css/drupal-rtl.css">');
    return false;
  });
  ...
  $(".layout-ltr").click(function (e) {
    ...
    $(this).addClass('active');
    $("html").attr("dir", 'ltr');
    $('link[href="/d8/themes/custom/progressive/css/drupal-rtl.css"]').remove();
    return false;
  });
